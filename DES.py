...
class des():
    ...
    def run(self, key, text, action=ENCRYPT, padding=False):
        ...
        if padding and action == DECRYPT:
            # Remove the padding if decrypt and padding is true (changed)
            return self.removePadding(final_res), rounds
        else:
            # Return the final string of data ciphered/deciphered (changed)
